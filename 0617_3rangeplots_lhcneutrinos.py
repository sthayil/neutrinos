...
#USAGE: python 0617...py e (or ebar or mu or mubar)
#LHC EDITION
...
#Constants DIFFERENT FOR LHC NU     
if flavour=='ebar' or flavour=='e':
    nbench=4.05754923311701e+16 #el
else:
    nbench=8.47584503622312e+17 #mu
print nbench

constt=5.09282e+19*1e-38*0.5 #*0.5 to account for equal contribution from nu and anti nu; multiply neutrino xsec factor of 1e-38 for lhc #s
...
for inputfile in inputfiles:
    picklename = inputfile[:-5]+'_lhc.pickle'
